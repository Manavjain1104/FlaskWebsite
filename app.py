...
# Defining the function for the blog page which the consumer can also access and its route for href tags for HTML.
@app.route('/blog')
def blog():
	return render_template("blog.html")

# Defining the function for the blog details page which the consumer can also access and its route for href tags for HTML.
